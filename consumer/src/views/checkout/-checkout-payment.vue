      ...
      <div class="time-way">
        ...
        <div class="pay-way-time">
          ...
          <a
            href="javascript:;"
            class="eui-checkbox-btn"
            :class="[receive_time === '周一至周五(8-12点)' && 'checked']"
            @click="receive_time = '周一至周五(8-12点)'"
          >周一至周五(8-12点)</a>

          <a
            href="javascript:;"
            class="eui-checkbox-btn"
            :class="[receive_time === '周一至周五(12-17点)' && 'checked']"
            @click="receive_time = '周一至周五(12-17点)'"
          >周一至周五(12-17点)</a>

          <a
            href="javascript:;"
            class="eui-checkbox-btn"
            :class="[receive_time === '周六至周日(8-12点)' && 'checked']"
            @click="receive_time = '周六至周日(8-12点)'"
          >周六至周日(8-12点)</a>

          <a
            href="javascript:;"
            class="eui-checkbox-btn"
            :class="[receive_time === '周六至周日(12-17点)' && 'checked']"
            @click="receive_time = '周六至周日(12-17点)'"
          >周六至周日(12-17点)</a>
        </div>
      </div>
    </div>
